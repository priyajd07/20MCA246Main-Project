...
public class viewotherspost extends AppCompatActivity {
    ListView l1;
    SharedPreferences sh;
    ArrayList<String> post,date,userdetails;
    String url;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_viewotherspost);
        l1=findViewById(R.id.lsv);
        //l1.setOnItemClickListener(viewfriendrequest.this);
        sh= PreferenceManager.getDefaultSharedPreferences(getApplicationContext());

        url ="http://"+sh.getString("ip", "") + ":5000/view_others_post";
        RequestQueue queue = Volley.newRequestQueue(viewotherspost.this);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0;i<ar.length();i++)
                    {
                        ...
                        userdetails.add(jo.getString("Status"));
                    ...
                    l1.setAdapter(new custom3(viewotherspost.this,post,date,userdetails));
            ...
            public void onErrorResponse(VolleyError error) {
                ...
                Toast.makeText(viewotherspost.this, "err"+error, Toast.LENGTH_SHORT).show();
            }
        }) {
            @Override
