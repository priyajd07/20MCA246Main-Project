...
class UploadMoviesWidget extends StatefulWidget {
  const UploadMoviesWidget({Key key}) : super(key: key);

  @override
  _UploadMoviesWidgetState createState() => _UploadMoviesWidgetState();
}

class _UploadMoviesWidgetState extends State<UploadMoviesWidget> {
  ...
  List<String> _selectedGeneres = [];
  List<String> _selectedRelatedVideos = [];
  ...
  Widget build(BuildContext context) {
    return languages.length==0?Center(child: CircularProgressIndicator(),): Scaffold(
      key: scaffoldKey,
      appBar: AppBar(
                        ...
                        return AlertDialog(
                          ...
                          actions: [
                            ...
                            TextButton(onPressed: (){
                              FirebaseFirestore.instance.collection('movie').add({
                                'title':title.text,
